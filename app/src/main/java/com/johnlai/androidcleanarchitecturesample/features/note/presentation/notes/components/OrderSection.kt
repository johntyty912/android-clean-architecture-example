package com.johnlai.androidcleanarchitecturesample.features.note.presentation.notes.components
...
fun OrderSectionPreview() {
    val noteOrder = remember {
        mutableStateOf<NoteOrder>(NoteOrder.Date(OrderType.Descending))
    }
    OrderSection(
